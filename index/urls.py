...
urlpatterns = [
    path('test/', views.image_request, name = "image-request"),
    ...
    path('allyourforms/', views.allyourforms, name="allyourforms"),
    path('alluserforms/', views.alluserforms, name="alluserforms"),
